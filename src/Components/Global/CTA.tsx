        ...
        <section className="py-8 pb-32 bg-gray-50 relative overflow-hidden">
            <div className="max-w-[1450px] mx-auto px-4 lg:px-8 relative z-10">
                <motion.div
                    ...
                    className="relative bg-[#800080] rounded-[30px] lg:rounded-3xl p-6 lg:p-10 overflow-hidden shadow-[0_30px_60px_-15px_rgba(128,0,128,0.25)]"
                >
                    ...
                    <div className="relative z-10 flex flex-col items-center text-center max-w-4xl mx-auto">
                        ...
                        >
                            ...
                            >
                                <div className="w-10 h-10 rounded-xl bg-white/10 backdrop-blur-md flex items-center justify-center group-hover:bg-white group-hover:text-[#800080] transition-all duration-300">
